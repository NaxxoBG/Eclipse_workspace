...
public class View {
   ...
   public void updateViewForBooked(ArrayList<Room> arrayList) {
      System.out.println("Booked rooms:");
      printRooms(arrayList);
   }
   public void updateViewForAvailable(ArrayList<Room> list) {
      System.out.println("Available rooms:");
      printRooms(list);
   } 

   public void printRooms(ArrayList<Room> arrayList){
      myIterator<Room> it = new myIterator<>(arrayList);
      String[] text;
      String line = "+--------+-----------------+----------+---------+";
      System.out.format(line+"\n");
