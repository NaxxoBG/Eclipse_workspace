...
public class Controller
{
   ...
   public boolean addNewBooking() {
      ...
      return model.getImplementation().addBooking(room,
            new Booking(room, dates[0], dates[1], guest));
   }
   ...
   public boolean editBooking() {
      ...
      Date[] dates = createDates();
      Guest guest = createGuest();
      return model.getImplementation().editBooking(booking, room, dates[0],
            dates[1], guest);
   }
   ...
   public void availableRooms() throws RemoteException {
      Date[] dates = createDates();
      view.printRooms(model.getImplementation().getAvailableRooms(dates[0],
            dates[1]));
   }

   public void bookedRooms() throws RemoteException {
      Date[] dates = createDates();
      view.printRooms(model.getImplementation().getBookedRooms(dates[0],
            dates[1]));
   }
   ...
   private Date createDate() {
      ...
      while (true) {
         ...
         cal.set(Integer.parseInt(array[2]), Integer.parseInt(array[1]) - 1,
