...
public class View
{
   ...
   public void printRooms(ArrayList<Room> arrayList) {
      String[] text;
      String line = "+--------+-----------------+----------+---------+";
      ...
      for (int i = 0; i < arrayList.size(); i++) {
         text = arrayList.get(i).toString().split(",");
         System.out.format(format, Integer.parseInt(text[0]), text[1],
               Integer.parseInt(text[2]), Double.parseDouble(text[3]));
      }
      System.out.format(line + "\n");
   }
   ...
   public void printBookings(ArrayList<Booking> list) {
      ...
      System.out.format(line + "\n");
      System.out
      .format("| Pos | Start date | End date   | Guest Name           | Guest ID      |\n");
      System.out.format(line + "\n");
   ...
   public void printMenu() {
      ...
      tasks.add("Add new booking");
      tasks.add("Edit booking");
