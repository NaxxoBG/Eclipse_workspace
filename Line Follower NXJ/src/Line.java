    ...
    public static void main (String[] aArg) throws Exception {
      ...
      Behavior Intersection = new Behavior() {
         ...
         public boolean takeControl() {
            ...
            boolean center = light.readValue() <= THRESHOLD;
         ...
         public void action() {
            ...
            LCD.clearDisplay();
            LCD.drawString("C: " + light.readValue(), 0, 0);
            LCD.drawString("L: " + light2.readValue(), 0, 1);
            LCD.drawString("R: " + light3.readValue(), 0, 2);
            LCD.drawString("Running Behavior: Intersection", 0, 3);
            LCD.drawString("Intersection", 0, 4);
            ...
            while (!suppressor) {
               ...
               LCD.drawString("L: " + light2.readValue(), 0, 1);
               LCD.drawString("R: " + light3.readValue(), 0, 2);
               LCD.drawString("Running Behavior", 0, 3);
               LCD.drawString("HunterSeeker", 0, 4);
               LCD.drawString("N: " + n, 0, 5);
