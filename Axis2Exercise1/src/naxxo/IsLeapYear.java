...
/**
 *  IsLeapYear bean class
 */
@SuppressWarnings({"unchecked",
    "unused", "serial"
})
public class IsLeapYear implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static IsLeapYear parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"isLeapYear".equals(type)) {
                            ...
                            return (IsLeapYear) naxxo.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
