...
/**
 *  IsLeapYearResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class IsLeapYearResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"isLeapYearResponse".equals(type)) {
                            ...
                            return (IsLeapYearResponse) naxxo.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
