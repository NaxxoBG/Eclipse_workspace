...
/**
 *  AverageOfTwo bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AverageOfTwo implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"averageOfTwo".equals(type)) {
                            ...
                            return (AverageOfTwo) naxxo.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
