...
/**
 *  ReverseResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReverseResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"reverseResponse".equals(type)) {
                            ...
                            return (ReverseResponse) naxxo.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
