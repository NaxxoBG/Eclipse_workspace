...
/**
 *  AverageOfThreeResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AverageOfThreeResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"averageOfThreeResponse".equals(type)) {
                            ...
                            return (AverageOfThreeResponse) naxxo.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
