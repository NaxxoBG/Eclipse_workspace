...
/**
 *  AverageOfTwoResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AverageOfTwoResponse implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"averageOfTwoResponse".equals(type)) {
                            ...
                            return (AverageOfTwoResponse) naxxo.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
