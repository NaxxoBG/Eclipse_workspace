            ...
            case "filter": 
               try {
                  ...
                  if (gui.getType().equals("Today") && gui.emptyDates()) {
                     ...
                     if (gui.getDateFrom() == null) {
                        playErrorSound();
                        JOptionPane.showMessageDialog(null, "Please choose a date for the beginning of the date range.", "Error", JOptionPane.ERROR_MESSAGE);  
                     } else if (gui.getDateTo() == null) {
