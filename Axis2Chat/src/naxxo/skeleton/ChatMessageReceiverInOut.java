...
/**
 *  ChatMessageReceiverInOut message receiver
 */
public class ChatMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
    public void invokeBusinessLogic(
        ...
        try {
            ...
            if ((op.getName() != null) &&
                ...
                if ("receiveMessage".equals(methodName)) {
                    naxxo.ReceiveMessageResponse receiveMessageResponse11 = null;
                    naxxo.ReceiveMessage wrappedParam = (naxxo.ReceiveMessage) fromOM(msgContext.getEnvelope()
                                                                                                .getBody()
                                                                                                .getFirstElement(),
                            naxxo.ReceiveMessage.class);

                    receiveMessageResponse11 = skel.receiveMessage(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            receiveMessageResponse11, false,
