...
public class AddressServerFrame extends JFrame implements AddressServerView
{
   ...
   public void setAddressServerController(AddressServerController controller) {
      this.controller = controller;
   }

   public AddressServerController getAddressServerController() {
