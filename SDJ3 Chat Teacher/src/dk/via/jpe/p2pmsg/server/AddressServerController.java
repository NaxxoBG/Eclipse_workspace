...
public class AddressServerController extends UnicastRemoteObject implements AddressServerInterface
{
   private PeerList peers = new PeerList();
   private AddressServerView view;

   public AddressServerController() throws RemoteException {}
